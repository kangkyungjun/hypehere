...
from . import views
# api_views excluded from git - contains lottery functionality
...
urlpatterns = [
    ...
    # Lottery API endpoints (excluded - requires api_views.py and lotto app)
    ...
    # Lottery Management API endpoints (excluded - requires api_views.py and lotto app)
