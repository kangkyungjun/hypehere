...
from .views import (
    ...
    post_like_toggle, post_unlike, post_favorite_toggle, PostCommentListCreateAPIView,
    CommentDetailAPIView, PostSearchAPIView, post_report_view, comment_report_view,
    comment_like_toggle, comment_unlike, log_interaction, RecommendedPostListAPIView,
...
urlpatterns = [
    ...
    path('<int:post_id>/comments/<int:comment_id>/unlike/', comment_unlike, name='comment_unlike'),
